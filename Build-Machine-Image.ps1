...
function New-JsonTemplate
{
    param (
        [string]$machineImage
            ...
            $InlineScriptUpdates="/tmp/linux/yumUpdateOS.sh"
    ...
    switch ($machineImage)
    {
        'centos6' {
            ...
            $Json.provisioners[1].inline = "$InlineScriptPermission && $InlineScriptEnvVars && $InlineScriptHostname && $InlineScriptProxy && $InlineScriptUpdates"
